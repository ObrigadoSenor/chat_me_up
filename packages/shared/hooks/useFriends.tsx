...
import { FriendsType, FriendType, Query, Subscription, UserType } from '../generated/serverTypes';
import { SEND_FRIEND_REQUEST } from '../queries/friendsQueries';
import { UPDATE_FRIEND_REQUEST } from '../queries/membersQueries';
